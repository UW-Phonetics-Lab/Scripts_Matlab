...
function createPerceptionExperimentFile()
    ...
    uicontrol('parent',leftRightScheme,'style','Radio','tag','mirrored','units','pixels','pos',[20 35 550 25],'string','Mono > Mirrored: each mono stimulus played to both left and right ears in separate trials');
    uicontrol('parent',leftRightScheme,'style','text','backgroundcolor',[0.5 0.8 0.5],'horizontalAlignment','left','units','pixels','pos',[142 10 400 25],'string','(note: this option requires an even number for "repetitions" above)');
    ...
    uicontrol('parent',userInputScheme,'style','Radio','tag','timeout','units','pixels','pos',[20 40 550 30],'string','Fixed Timeout: next stimulus plays after specified duration (plus any I.S.I. set above)');
